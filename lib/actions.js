...
export async function getReadNotificationsByUserId(userId) {
  try {
    ...
    console.error("Error fetching unread notifications by user ID:", error.message);
...
export async function getLessonExercisesByEnrolledUser( userId, lessonId, courseId ) {
  try {
    ...
    console.error("Error fetching exercises by user ID and lesson ID:", error.message);
