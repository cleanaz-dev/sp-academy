...
export async function checkAchievements(body) {
  try {
    ...
    // In the checkAchievements function, modify the userProgress query:
    const userProgress = await prisma.userProgress.findMany({
      where: {
        userId: user.id,
        isUnlocked: false, // Add this filter to only get locked achievements
      },
      include: {
        achievement: true,
      },
