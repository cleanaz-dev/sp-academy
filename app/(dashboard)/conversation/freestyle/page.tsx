...
export default async function FreestylePage() {
  ...
  return (
    ...
    <div className="flex-1 w-full h-[calc(100dvh-50px)] animate-gradient bg-linear-to-r from-sky-400 via-emerald-400 to-violet-400 bg-size-[300%_300%] overflow-hidden flex flex-col">
      <FreestyleWrapper
        userId={user?.id}
