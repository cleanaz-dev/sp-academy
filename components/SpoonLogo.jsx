...
<div className="bg-gradient-to-r from-sky-400 via-emerald-400 to-violet-400 bg-[length:300%_300%] animate-[gradient_6s_ease_infinite] text-white text-center p-16  w-full">
      ...
      // Sidebar
        <aside className="bg-gradient-to-r from-sky-400 via-emerald-400 to-amber-400 bg-[length:200%_200%] animate-gradient-x text-white w-64 flex flex-col justify-between p-4">
          ...
          <div>
            <button className="bg-emerald-400 text-gray-900 px-4 py-2 rounded-lg w-full hover:bg-emerald-500 transition">
              Logout
            </button>
          </div>
        </aside>
        ...
        <main className="flex-1 bg-white p-8">
          ...
          <p className="text-gray-700">
            This is your dashboard. Here you can manage courses, settings, and
            much more!
          </p>
        </main>
      </div> */}
