 ...
 return (
  ...
  <main className="max-w-7xl">
    ...
    <header className="bg-white p-4 flex justify-between items-center">
      <h1 className="header-title">Lessons</h1>
    </header>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
      {lessons.map((lesson) => (
        <Card
          key={lesson.id}
          className="svg-background flex flex-col h-full" // Ensure card is a flex container
        >
          <CardHeader>
          ...
          <CardContent className="flex-grow flex flex-col justify-end">
            <div className="">
              ...
              <div className="bg-white border my-4 rounded-md min-h-48">
                <p className="text-sm p-2 text-slate-500">{lesson.description}</p>
              </div>
            </div>
            <div>
