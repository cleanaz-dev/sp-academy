// components/journal/interactive-review-modal.tsx
"use client";
...
interface InteractiveReviewModalProps {
  onClose: () => void;
  onComplete: () => void;
  journal: any; // Passed directly from the page's completedDates map
}
...
export default function InteractiveReviewModal({ onClose, onComplete, journal }: InteractiveReviewModalProps) {
  ...
  // Parse Word Analysis (Looking for Mispronunciations, Omissions, etc.)
  const mispronouncedWords = useMemo(() => {
    ...
    // Filter out words that were spoken perfectly
        ...
        <section className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm flex flex-col">
              ...
              {/* If there are mispronounced words, show them here! */}
