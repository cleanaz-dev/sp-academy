    ...
    <>
      ...
      <Modal size={size} open={open} onClose={handleClose}>
        <form action={recordJournal}>
          <Modal.Header>
            <Modal.Title>
              Are you ready to record your journal today{" "}
              <span className="font-bold">{user?.firstName}</span>!😄{" "}
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <p className="text-slate-600">
              Please go somewhere quiet and not too noisy so we can record your
              journal. <br />
            ...
            <div className="my-4 p-1 space-y-2">
              ...
              <div className="flex gap-2 items-center">
                ...
                <p className="text-sm text-green-500">
                  All journals are recorded and used to enhance speech and
                  vocabulary development. Please provide your consent to
                  proceed.
                </p>
              </div>
            </div>
