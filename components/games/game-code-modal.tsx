  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger
        render={
          <Button
            variant={currentCode ? "outline" : "default"}
      ...
      <DialogContent className="bg-white sm:max-w-3xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Paste your raw React/TSX component code here. The AI will read this
            code to understand how to generate compatible content.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="py-4">
          <Textarea
            ...
            className="min-h-[400px] bg-slate-950 font-mono text-xs text-emerald-400"
            spellCheck={false}
          />
        </div>
