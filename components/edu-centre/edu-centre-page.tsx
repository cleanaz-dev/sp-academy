...
import { EnrollmentDialog } from "../learning-hub/EnrollmentDialog";
import { RecommendedDetailsDialog } from "../learning-hub/RecommnedDetailsDialog";
...
export default function EduCenterPage({ courses, userId }) {
