  ...
  return (
   <>
    ...
    <form action={recordStoryQuestions}>
     <Modal.Header>
      <Modal.Title>
       Are you ready to practice speaking based on the story <span className="font-bold">{user?.firstName}</span>!😄{" "}
      </Modal.Title>
     </Modal.Header>
     <Modal.Body>
       ...
       <div className="my-4 p-1 space-y-2">
        ...
        <div className="flex gap-2 items-center">
         ...
         <p className="text-sm text-green-500">
          All answers are recorded and used to improving speech and vocabulary.
